...
// NodeRecoveryApplyConfiguration represents a declarative configuration of the NodeRecovery type for use
// with apply.
...
// NodeRecovery constructs a declarative configuration of the NodeRecovery type for use with
// apply.
func NodeRecovery(name string) *NodeRecoveryApplyConfiguration {
	b := &NodeRecoveryApplyConfiguration{}
	b.WithName(name)
	b.WithKind("NodeRecovery")
...
func (b *NodeRecoveryApplyConfiguration) ensureObjectMetaApplyConfigurationExists() {
